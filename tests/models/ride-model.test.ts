...
const mockedGetRidesData = getRidesData as jest.MockedFunction<typeof getRidesData>;
...
describe('Ride Model', () => {
    ...
    it('should handle error from getRidesData', async () => {
        ...
        await expect(rideModel.getRidesByPark('Coney Island')).rejects.toThrow('Failed to fetch rides data');
    });
});
